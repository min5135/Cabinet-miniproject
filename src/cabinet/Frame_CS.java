...
//		setVisible(true);
    ...
    private void initGUI() {                           //jpanel
        ...
        contentPane2.add(this.tfRno);
        lblNewLabel.setForeground(Color.pink);//cabinet 1F

        this.label.setBounds(290, 5, 100, 28);
        contentPane2.add(this.label);
        this.tfSno.setColumns(10);
        this.tfSno.setBounds(290, 33, 128, 28);
        contentPane2.add(this.tfSno);
        label.setForeground(Color.pink);//락커번호
        ...
        contentPane2.add(this.tfState);
        label_1.setForeground(Color.pink);//사용유무

        this.label_2.setBounds(590, 5, 73, 28);
        contentPane2.add(this.label_2);
        this.tfId.setColumns(10);
        this.tfId.setBounds(590, 33, 128, 28);
        contentPane2.add(this.tfId);
        label_2.setForeground(Color.pink);//아이디
        ...
        contentPane2.add(this.tfPeriod);
        label_3.setForeground(Color.pink);//남은기간
        ...
        */
        ...
        lblBG.setIcon(new ImageIcon("C:\\airplane project\\src\\images\\3.jpg"));
        lblBG.setBounds(0, -46, 1000, 700);
    ...
    public void showData(int n) {
        ...
        String[] colNames = {"캐비넷 위치", "락커번호", "사용유무", "아이디",
                "남은기간"};
